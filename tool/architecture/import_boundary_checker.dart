...
final architecturePolicy = ArchitecturePolicy(
  legacyApplicationDataEdges: {
    ...
    ImportEdge(
      ...
      targetPath:
          'lib/features/settings/data/fixed_prompt_sequence_repository.dart',
    ...
    ImportEdge(
      sourcePath:
          'lib/features/settings/application/memory_prompts_controller.dart',
      targetPath:
          'lib/features/settings/data/sqlite_memory_prompt_repository.dart',
    ...
    ImportEdge(
      sourcePath:
          'lib/features/settings/application/template_prompts_controller.dart',
