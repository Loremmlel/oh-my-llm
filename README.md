...
| ChatSessionsController | `test/features/chat/application/chat_sessions_controller_test.dart` | 24 | 会话增删改、消息树编辑、重试、错误处理 |
| AppDatabase Migration | `test/core/persistence/app_database_migration_test.dart` | 17 | V1-V3 schema、外键级联、索引 |
